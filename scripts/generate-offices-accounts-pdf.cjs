...
const accountRows = [
  ...
  ["staff2@parsu.edu.ph", "office_staff", "Active", "Pedro Penduko", "Office of Student Affairs and Services (head)", SEED_PASSWORD],
  ...
  ["osas@parsu.edu.ph", "osas", "Active", "Cristina Bautista", "Student-domain sub-admin", SEED_PASSWORD],
];
...
bullets([
  ...
  "Every one of the 11 seeded offices/colleges has exactly one assigned head/dean and at least one active office_staff login capable of signing in.",
  "The Office of the University Registrar (OUR) is the only office with a second, non-head staff login (staff3@parsu.edu.ph); every other office's head account is also its sole staff login.",
  ...
  "Verified directly against the live database: 11/11 offices have an active head and active staff login; all 5 colleges have active enrolled students; sample password hashes (admin, dean.ced, staff, student) matched the shared seed password.",
]);

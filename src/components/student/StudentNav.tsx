...
const NAV_ITEMS = [
  ...
  { href: "/student/complaints", label: "My Complaints", icon: Inbox },
  { href: "/student/complaints/new", label: "Submit", icon: ClipboardList },
  { href: "/student/feedback/new", label: "Feedback", icon: MessageSquarePlus },
];

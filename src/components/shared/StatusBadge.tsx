...
const STATUS_STYLES: Record<ComplaintStatus, { label: string; className: string }> = {
  submitted: { label: "Submitted", className: "bg-[var(--muted)] text-[var(--muted-foreground)]" },
  assigned: { label: "Assigned", className: "bg-[var(--secondary)]/20 text-[var(--secondary)]" },
  in_progress: { label: "In Progress", className: "bg-[var(--primary)]/20 text-[var(--primary)]" },
  pending_information: {
  ...
  closed: { label: "Closed", className: "bg-[var(--border)] text-[var(--muted-foreground)]" },
};
